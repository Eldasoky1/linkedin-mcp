...
async function main() {
  ...
  for (const opt of opts) {
    ...
    console.log(`  [OK] Save clicked for "${opt}"`);
  }
  ...
  const checks = ["CompliAI", "CRM Pipeline", "AVR Microcontroller", "MCP Server", "Systems Developer"];
